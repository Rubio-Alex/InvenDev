...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../css/stylePrr.css" />
</head>
...
<body>
	...
	<main class="main-content">
		...
		<section class="container top-products">
			...
			<h1 class="heading-1">Proveedores</h1>
...
<!--.....................................................................-->
							...
							<form method="post">
                                <input class="controls" type="text" placeholder="Empresa Proveedor" name="emProv"> 

                                <input class="controls" type="text" placeholder="Nombre del Proveedor" name="nomProv"> 

                                <input class="controls" type="number" placeholder="Telefono" name="telProv">

                                <input class="controls" type="text" placeholder="Email" name="emaProv">
