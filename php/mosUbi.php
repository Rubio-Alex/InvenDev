...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../css/stylemCat.css" />
</head>
...
<body>
	...
	<main class="main-content">
		...
		<section class="container top-products">
			...
			<h1 class="heading-1">Datos Marcas</h1>
					...
					<div class="content-card-product">
						...
						<section class="form-register">
                            ...
                            <table border="1" >
                                ...
                                <tr class="tab2">
                                    <td class="tab3"><?php echo $mostrar['IdUbica'] ?></td>
                                    <td class="tab3"><?php echo $mostrar['nomUbicacion'] ?></td>
