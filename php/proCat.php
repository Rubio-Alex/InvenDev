...
<body>
	...
	<main class="main-content">
		...
		<section class="container top-products">
			...
			<h1 class="heading-1">Procedimientos Categorias</h1>
				...
				<div class="card-product">
					...
					<div class="content-card-product">
						...
						<section class="form-register">
							...
							Categoria: <input type="text" name="categorias">
							...
							$Marca= $_POST['categorias'];
							
							$TablaV = mysqli_query($conexion,"CALL rutiCats('$Marca')") // conexion a la bd y despues la consulta
