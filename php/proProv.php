...
<body>
	...
	<main class="main-content">
		...
		<section class="container top-products">
			...
			<h1 class="heading-1">Procedimientos Proveedores</h1>
				...
				<div class="card-product">
					...
					<div class="content-card-product">
						...
						<section class="form-register">
							...
							Empresa Proveedor: <input type="text" name="empresa">
							...
							$TablaV = mysqli_query($conexion,"CALL rutiProve('$Marca')") // conexion a la bd y despues la consulta
						...
						<tr class="tab2">
							...
							<td class="tab3"><?php echo $fila['nomProv'] ?></td>
							<td class="tab3"><?php echo $fila['numProv'] ?></td>
							<td class="tab3"><?php echo $fila['emailProv'] ?></td>
