						...
						<section class="form-register">
                            ...
                            <table border="1" >
								...
								<?php 
									...
									<tr class="tab2">
										<td class="tab3"><?php echo $mostrar['IdProv'] ?></td>
										<td class="tab3"><?php echo $mostrar['empProv'] ?></td>
										<td class="tab3"><?php echo $mostrar['nomProv'] ?></td>
										<td class="tab3"><?php echo $mostrar['numProv'] ?></td>
										<td class="tab3"><?php echo $mostrar['emailProv'] ?></td>
