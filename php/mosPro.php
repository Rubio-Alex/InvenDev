...
<body>
	...
	<main class="main-content">
		...
		<section class="container top-products">
			...
			<h1 class="heading-1">Datos Productos</h1>
						...
						<section class="form-register">
                            ...
                            <table border="1" >
								...
								<?php 
									...
									$consulta="SELECT * FROM productos"; //nombre de la tabla en la bd
									...
									<tr class="tab2">
										<td class="tab3"><?php echo $mostrar['IdProduc'] ?></td>
										<td class="tab3"><?php echo $mostrar['nomProduc'] ?></td>
										<td class="tab3"><?php echo $mostrar['desProduc'] ?></td>
										<td class="tab3"><?php echo $mostrar['marProduc'] ?></td>
										<td class="tab3"><?php echo $mostrar['catProduc'] ?></td>
										<td class="tab3"><?php echo $mostrar['pCompra'] ?></td>
										<td class="tab3"><?php echo $mostrar['pVenta'] ?></td>
										<td class="tab3"><?php echo $mostrar['emProve'] ?></td>
										<td class="tab3"><?php echo $mostrar['stock'] ?></td>
										<td class="tab3"><?php echo $mostrar['stockMin'] ?></td>
										<td class="tab3"><?php echo $mostrar['ubicacion'] ?></td>
									</tr>
									<?php 
									}
								?>
