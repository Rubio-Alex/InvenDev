...
<body>
	...
	<main class="main-content">
		...
		<section class="container top-products">
			...
			<h1 class="heading-1">Procedimientos Ubicacion</h1>
				...
				<div class="card-product">
					...
					<div class="content-card-product">
						...
						<section class="form-register">
							...
							Productos guardados en el N°Ubicacion: <input type="text" name="lugar">
							...
							$TablaV = mysqli_query($conexion,"CALL rutiUbi('$Marca')") // conexion a la bd y despues la consulta
						...
						<tr class="tab2">
							...
							<td class="tab3"><?php echo $fila['marProduc'] ?></td>
							<td class="tab3"><?php echo $fila['catProduc'] ?></td>
							<td class="tab3"><?php echo $fila['emProve'] ?></td>
							<td class="tab3"><?php echo $fila['stock'] ?></td>
							<td class="tab3"><?php echo $fila['stockMin'] ?></td>
